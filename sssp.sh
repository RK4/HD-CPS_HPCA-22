...
./PMOD/Galois-2.2.1/build_final/apps/sssp/sssp ~/work/datasets/USA-road-dUSA.bin -algo async -t 40 -startNode 0 -wl obim -delta 14 > temp
...
./Galois/build_release/lonestar/sssp ~/work/datasets/USA-road-dUSA.bin -algo deltaStep_hdcps -t 40 -startNode 0  -delta 14 > temp
grep 'Elapsed time:' >> output/sssp.out
cat temp | grep "PD"| tail -n1 >> output/sssp.out
